...
@Component({
    tag: 'xkovalcikc-ambulance-wl-editor',
    styleUrl: 'xkovalcikc-ambulance-wl-editor.css',
    shadow: true,
})
export class XkovalcikcAmbulanceWlEditor {
    @Prop() entryId: string;
        ...
        return (
            <Host>
                <form ref={el => (this.formElement = el)}>
                    ...
                    <md-filled-text-field label="Čakáte od" value={new Date(this.entry?.waitingSince || Date.now()).toLocaleTimeString()}>
