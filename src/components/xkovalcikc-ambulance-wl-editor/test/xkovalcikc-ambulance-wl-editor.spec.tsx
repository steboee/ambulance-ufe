...
describe('xkovalcikc-ambulance-wl-editor', () => {
    ...
    it('buttons shall be of different type', async () => {
        ...
        const page = await newSpecPage({
            ...
            html: `<xkovalcikc-ambulance-wl-editor entry-id="test-entry"
    ...
    it('first text field is patient name', async () => {
        ...
        const page = await newSpecPage({
            components: [XkovalcikcAmbulanceWlEditor],
            html: `<xkovalcikc-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></xkovalcikc-ambulance-wl-editor>`,
        });
